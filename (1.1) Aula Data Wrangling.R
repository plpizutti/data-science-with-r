...
base_exclui <- transmute(nova_base, #seleciona o dataset
                         observacoes, tempo, # mantém estas variaveis do dataset
                         variavel_nova_1, variavel_nova_2) #inclui novas variaveis
